...
#-----------------------------------------------------------
LOCAL_SRC_FILES += camera_calibration_cam_cal.cpp
LOCAL_SRC_FILES += camera_calibration_eeprom.cpp
LOCAL_SRC_FILES += cfg_setting_imgsensor.cpp
LOCAL_SRC_FILES += sensorlist.cpp
...
ifeq ($(CUSTOM_KERNEL_SUB_IMGSENSOR), gc0310_yuv)
