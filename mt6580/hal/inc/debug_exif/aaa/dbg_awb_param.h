...
enum
{
    ...
    AWB_NVRAM_SUNSET_VERTEX_XR_THR,
    AWB_NVRAM_SUNSET_VERTEX_YR_THR,
    ...
    AWB_NVRAM_LOW_CCT_AREA_XR_THR,
    AWB_NVRAM_LOW_CCT_AREA_YR_THR,
    AWB_NVRAM_LOW_CCT_VERTEX_XR_THR,
    AWB_NVRAM_LOW_CCT_VERTEX_YR_THR,
