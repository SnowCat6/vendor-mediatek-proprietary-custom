 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_OV5671_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1280x960",     "1600x1200",    "1920x1080",	"1920x1088",    "2048x1536",    "2560x1440",
                "2560x1920",    "2880x1728",    "2624x1968",  // This is the max picture size, ratio is 4:3, which is the nearly to the max preview size ratio
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1680x1260", // This is the max preview size, ratio is 4:3, which is the same to the max picture size ratio
            )
        ),
    )
#endif
...
if(facing == 0) /*back sensor*/
{
    ...
    //==========================================================================
    //  Video Face Beauty
#ifdef VIDEO_FACEBEAUTY_SUPPORT
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
...
#endif
#ifdef SLOW_MOTION_VIDEO_SUPPORT
    //	Slow Motion
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
