...
REQUEST_METADATA_BEGIN(SENSOR_DRVNAME_IMX179_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.color
//------------------------------------------------------------------------------
    //==========================================================================// none
...
//------------------------------------------------------------------------------
    ...
    case CAMERA3_TEMPLATE_STILL_CAPTURE:
        ...
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_NOISE_REDUCTION_MODE)//NOISE_REDUCTION_MODE_HIGH_QUALITY MTK_NOISE_REDUCTION_MODE_FAST
        ...
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_TONEMAP_MODE)//NOISE_REDUCTION_MODE_HIGH_QUALITY MTK_TONEMAP_MODE_FAST
