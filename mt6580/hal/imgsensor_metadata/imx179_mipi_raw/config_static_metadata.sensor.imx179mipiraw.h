...
STATIC_METADATA2_BEGIN(DEVICE, SENSOR, SENSOR_DRVNAME_IMX179_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.sensor
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_ACTIVE_ARRAY_REGION)
        CONFIG_ENTRY_VALUE(MRect(MPoint(0, 0), MSize(3280, 2464)), MRect)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_SENSITIVITY_RANGE)
        CONFIG_ENTRY_VALUE(43, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PHYSICAL_SIZE) // mm
        CONFIG_ENTRY_VALUE(4.59f, MFLOAT)
        CONFIG_ENTRY_VALUE(3.45f, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PIXEL_ARRAY_SIZE)
        CONFIG_ENTRY_VALUE(MSize(3280, 2464), MSize)
    CONFIG_METADATA_END()
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PACKAGE)
        ...
        CONFIG_ENTRY_METADATA(
            ...
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_REAL_OUTPUT_SIZE)
                CONFIG_ENTRY_VALUE(MSize(1640,  1232),MSize)
            CONFIG_METADATA2_END()
            //..................................................................
