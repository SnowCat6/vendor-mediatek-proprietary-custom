...
#include "camera_AE_PLineTable_s5k4e2gxmipiraw.h"
#include "camera_info_s5k4e2gxmipiraw.h"
...
static void get_flicker_para_by_ZSD(FLICKER_CUST_PARA* para)
{
  ...
  FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
  FLICKER_CUST_STATISTICS EV50_L60 = {1213, 383, 715, -373};
  FLICKER_CUST_STATISTICS EV60_L50 = {1447, 403, 1065, -447};
  FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
