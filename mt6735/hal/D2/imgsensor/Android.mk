...
#-----------------------------------------------------------
LOCAL_SRC_FILES += $(foreach f, $(CUSTOM_HAL_IMGSENSOR), $(call all-cpp-files-under, $(strip $(f))))
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM)/kernel/imgsensor_src
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM)/hal/D2/inc/imgsensor
