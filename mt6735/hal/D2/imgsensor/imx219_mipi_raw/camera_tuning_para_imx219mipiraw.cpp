        ...
        {
            {
                ...
                // PWB light area
                {
		            ...
		            // Cloudy daylight
		            {
		                ...
		                95, // PCloudyLeftBound
		                -295, // PCloudyUpperBound
		                -385 // PCloudyLowerBound
		            },
		            // Shade
		            {
		                370, // PShadeRightBound
		                95, // PShadeLeftBound
		                -295, // PShadeUpperBound
		                -385 // PShadeLowerBound
		            },
		            // Twilight
		            {
		                -43, // PTwiRightBound
		            ...
		            // Warm fluorescent
		            {
		                ...
		                -438, // PWFluoLeftBound
		                -299, // PWFluoUpperBound
		                -471 // PWFluoLowerBound
		            },
		            // Incandescent
		            {
		                -238, // PIncaRightBound
                ...
                // AWB preference color
                {
		            ...
		            // Sunset Area
		            {
		                ...
		                -392 // i4Sunset_BoundXr_Thr
		            },
		            // Sunset Vertex
		            {
		                74, // i4Sunset_VertexXr_Thr
		                -392 // i4Sunset_VertexXr_Thr
		            },
		            // Shade F Area
		            {
		                -244, // i4Sunset_BoundXr_Thr
		                -365 // i4Sunset_BoundXr_Thr
		            },
		            // Shade F Vertex
		            {
		                -144, // i4Sunset_VertexXr_Thr
		                -375 // i4Sunset_VertexXr_Thr
		            },
		            // Shade CWF Area
		            {
		                -244, // i4Sunset_BoundXr_Thr
		                -450 // i4Sunset_BoundXr_Thr
		            },
		            // Shade CWF Vertex
		            {
		                -142, // i4Sunset_VertexXr_Thr
		                -463 // i4Sunset_VertexXr_Thr
		            },
		            // Low CCT Area
		            {
		                -497, // i4Sunset_BoundXr_Thr
		                12 // i4Sunset_BoundXr_Thr
		            },
		            // Low CCT Vertex
		            {
		                -497, // i4Sunset_VertexXr_Thr
		                12 // i4Sunset_VertexXr_Thr
                    }
                ...
                // CCT estimation
                {
	                ...
	                {
		                -592,  // RotatedXCoordinate0
		                -453,  // RotatedXCoordinate1
		                -296,  // RotatedXCoordinate2
		                -92,  // RotatedXCoordinate3
            ...
            // Algorithm Tuning Paramter
            {
                ...
                // AWB daylight locus probability look-up table (Max: 100; Min: 0)
                {
                    ...
                    { 90,  90,  90,  90,  90,  90,  90,  90,  90,  90,   90,   75,  50,  30,  30,  30,  0,   0,   0}, // CWF
