...
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_GC0310_MIPI_YUV_CONFIGFTBL__H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_GC0310_MIPI_YUV_CONFIGFTBL__H_
//#if 1
//
...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
				"256x144", "320x240", "512x288",  "640x480",
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
			   	"176x144", "256x144", "320x240", "352x288", "480x320",  "400x240", "512x288", "560x336", "640x480",
            )
        ), 
    )
#endif
