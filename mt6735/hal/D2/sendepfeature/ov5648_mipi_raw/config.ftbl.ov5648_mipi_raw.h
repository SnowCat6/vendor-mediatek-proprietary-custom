    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1280x960",     "1600x1200",    "1920x1088",    "2048x1536",    "2560x1440",    "2560x1920",
                "2880x1728",
                //"3264x2448",    "3328x1872",
                //"2880x1728",    "3600x2160",
            )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "864x480",      "1280x720",     "720x480",      "1280x736",
            )
        ),
    )
}
else
{
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "640x480",
                "720x480",      "864x480",      "1280x720",     "1280x736",
            )
        ),
    )
}
...
else
{
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::FALSE),
            ITEM_AS_SUPPORTED_(
#ifdef VIDEO_FACEBEAUTY_SUPPORTED
                MtkCameraParameters::TRUE
#else
                MtkCameraParameters::FALSE
#endif
