...
STATIC_METADATA2_BEGIN(DEVICE, SENSOR, SENSOR_DRVNAME_IMX135_MIPI_RAW_8MP)
//------------------------------------------------------------------------------
//  android.sensor
//------------------------------------------------------------------------------
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PACKAGE)
        ...
        CONFIG_ENTRY_METADATA(
            ...
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_OUTPUT_REGION_ON_ACTIVE_ARRAY)
                CONFIG_ENTRY_VALUE(MRect(MPoint(2, 2), MSize(2088, 1544)),MRect)
            CONFIG_METADATA2_END()
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_REAL_OUTPUT_SIZE)
                CONFIG_ENTRY_VALUE(MSize(4572, 1640),MSize)
            CONFIG_METADATA2_END()
            //..................................................................
        ...
        CONFIG_ENTRY_METADATA(
            ...
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_OUTPUT_REGION_ON_ACTIVE_ARRAY)
                CONFIG_ENTRY_VALUE(MRect(MPoint(4, 4), MSize(4176, 3088)),MRect)
            CONFIG_METADATA2_END()
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_REAL_OUTPUT_SIZE)
                CONFIG_ENTRY_VALUE(MSize(4572, 3146),MSize)
            CONFIG_METADATA2_END()
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_ROLLING_SHUTTER_SKEW)
                CONFIG_ENTRY_VALUE(33000000,MINT64) // nanosecond
        ...
        CONFIG_ENTRY_METADATA(
            ...
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_OUTPUT_REGION_ON_ACTIVE_ARRAY)
                CONFIG_ENTRY_VALUE(MRect(MPoint(2, 2), MSize(4192, 3104)),MRect)
            CONFIG_METADATA2_END()
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_INFO_REAL_OUTPUT_SIZE)
                CONFIG_ENTRY_VALUE(MSize(4572, 3144),MSize)
            CONFIG_METADATA2_END()
            //..................................................................
            CONFIG_METADATA2_BEGIN(MTK_SENSOR_ROLLING_SHUTTER_SKEW)
                CONFIG_ENTRY_VALUE(33000000,MINT64) // nanosecond
