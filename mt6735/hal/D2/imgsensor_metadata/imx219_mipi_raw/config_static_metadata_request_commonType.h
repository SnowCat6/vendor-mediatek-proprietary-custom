...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_IMX219_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_TONEMAP_GAMMA, MINT32)
        CONFIG_ENTRY_VALUE(MTK_TONEMAP_PRESET_CURVE, MINT32)
