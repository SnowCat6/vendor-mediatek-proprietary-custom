...
LOCAL_SRC_FILES += flash_custom.cpp
LOCAL_SRC_FILES += flash_custom_1.cpp
LOCAL_SRC_FILES += flash_custom_2.cpp
LOCAL_SRC_FILES += flash_custom_3.cpp
LOCAL_SRC_FILES += flash_light.cpp
LOCAL_SRC_FILES += flash_tuning_2ndPart_cct_main2.cpp
LOCAL_SRC_FILES += flash_tuning_2ndPart_cct_sub2.cpp
LOCAL_SRC_FILES += flash_tuning_2ndPart_main2.cpp
LOCAL_SRC_FILES += flash_tuning_2ndPart_sub2.cpp
LOCAL_SRC_FILES += flash_tuning_custom.cpp
LOCAL_SRC_FILES += flash_tuning_custom_cct.cpp
LOCAL_SRC_FILES += flash_tuning_custom_cct_sub.cpp
LOCAL_SRC_FILES += flash_tuning_custom_sub.cpp
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM)/hal/D2/flashlight
