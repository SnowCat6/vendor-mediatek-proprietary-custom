...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
            #if defined(PROJECT_TB6735P1_WSVGA) || defined(PROJECT_TB6735P1_WSVGA_LTTG) || defined(PROJECT_TB6735P1_WSVGA_OM_SVLTE) || defined(PROJECT_TB6735P1_WSVGA_WIFI) || defined(PROJECT_TB6735P1_WSVGA_WORLDPHONE)
				// 4:3
				...
				"800x480",      "1600x960",
				// 16:9
                "1280x720",     "1280x768",     "1920x1088",  	"2048x1152",
			#else
            	// 4:3
                "320x240",      "640x480",      "1024x768", 	"1280x960", "1600x1200",
				// 3:2
