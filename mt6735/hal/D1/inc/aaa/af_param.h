...
#ifndef _AF_PARAM_H
#define _AF_PARAM_H
#define AF_PARAM_REVISION 6112001
...
typedef struct
{
    ...
    MINT32  i4PDafTuningLevel0;
    MINT32  i4PDafTuningLevel1;
    MINT32  i4PDafTuningLevel2;
    MINT32  i4PDafTuningLevel3;
    MINT32 i4TBLL;
    ...
    // PD+LASER
    MINT32  i4LDafTuningLevel0;
    MINT32  i4LDafTuningLevel1;
    MINT32  i4LDafTuningLevel2;
    MINT32  i4LDafTuningLevel3;
    MINT32  i4SDafTuningLevel0;
    MINT32  i4SDafTuningLevel1;
    MINT32  i4SDafTuningLevel2;
    MINT32  i4SDafTuningLevel3;

    //Multi Source
    MINT32 i4DafMultiHigh[DafMultiSourceLength];
    MINT32 i4DafMultiMid[DafMultiSourceLength];
    MINT32 i4DafMultiLow[DafMultiSourceLength];
} AF_PARAM_T;
