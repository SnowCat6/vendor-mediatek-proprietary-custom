...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4888000, -2152000, -176000, -790000, 3864000, -510000, -96000, -2640000, 5296000
        },
        {  // i4P10[9]
            949928, -352858, -597069, 56550, 353467, -428399, -263131, -1346409, 1609540
        },
        {  // i4P01[9]
            695174, 244929, -940103, -230959, 599891, -387951, -523072, -2435225, 2958297
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            0,    // u4Video1ExpUnit
            0,    // u4Video1MaxFrameRate
            0,    // u4Video12PreRatio, 1024 base = 1x
            0,    // u4Video2ExpUnit
            0,    // u4Video2MaxFrameRate
            0,    // u4Video22PreRatio, 1024 base = 1x
            0,    // u4Custom1ExpUnit
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    -294,    // PWFluoRightBound
                    -494,    // PWFluoLeftBound
                    -149,    // PWFluoUpperBound
                    -337    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -294,    // PIncaRightBound
            ...
            // AWB preference color	
            {
                ...
                // Sunset Area
                {
                    -93,   // i4Sunset_BoundXr_Thr
                    -218    // i4Sunset_BoundYr_Thr
                },
                // Sunset Vertex
                {
                    -93,   // i4Sunset_BoundXr_Thr
            ...
            // CCT estimation
            {
                ...
                {
                -375,    // i4RotatedXCoordinate[0]
                -355,    // i4RotatedXCoordinate[1]
                -204,    // i4RotatedXCoordinate[2]
                -84,    // i4RotatedXCoordinate[3]
