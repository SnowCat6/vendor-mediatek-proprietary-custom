...
const NVRAM_LENS_PARA_STRUCT DUMMY_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        // -------------------- sAF_TH ---------------------
        {
            ...
            {8, 6, 9, 8, 10, 9, 9, 9}, // i4HW_TH[ISO_MAX_NUM];
           
            {0,0,0,0,0,0,0,0}, // i4FV_DC2[ISO_MAX_NUM];
          
            {0,0,0,0,0,0,0,0}, // i4MIN_TH2[ISO_MAX_NUM];
           
            {15, 11, 15, 14, 16, 15, 14, 15} // i4HW_TH2[ISO_MAX_NUM];
        },
         // ------------------- sZSDAF_TH -----------------------------------
        {
            8, // i4ISONum;
            ...
            {10, 6, 10, 8, 10, 10, 10, 10}, // i4HW_TH[ISO_MAX_NUM];
            
            {0,0,0,0,0,0,0,0}, // i4FV_DC2[ISO_MAX_NUM];
           
            {0,0,0,0,0,0,0,0}, // i4MIN_TH2[ISO_MAX_NUM];

            {15, 10, 15, 14, 15, 15, 14, 15} // i4HW_TH2[ISO_MAX_NUM];
        },
        // -------------------- sVID_AF_TH ---------------------
        {
            0, // i4ISONum;
