...
ifeq ($(wildcard $(MTK_PATH_CUSTOM)/hal/lens),)
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, src )
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, sensordrive )
LOCAL_SRC_FILES += $(foreach f, $(CUSTOM_HAL_LENS), $(call all-c-cpp-under, $(strip $(f))))
