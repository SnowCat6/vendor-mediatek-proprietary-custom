...
#ifdef DEFAULT_TURN_OFF_LOUDNESS
    (DEFAULT_AUDIO_AUDENH_CONTROL_OPTION_Coeff & (~0x00000002))
#else
...
AUDIO_CUSTOM_AUDIO_FUNC_SWITCH_PARAM_STRUCT audio_func_swtich_param_custom_default = {
    DEFAULT_VMLOG_DUMP_CONFIG,
    DEFAULT_BGS_DUMP_ENABLE,
    DEFAULT_CUSTOM_XML_ENABLE
};
