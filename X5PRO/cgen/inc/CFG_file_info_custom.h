...
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        { "/data/nvram/APCFG/APRDCL/Audio_BT_Gain",   VER(AP_CFG_RDCL_FILE_AUDIO_BT_GAIN_CUSTOM_LID), CFG_FILE_AUDIO_BT_GAIN_CUSTOM_SIZE,
            CFG_FILE_AUDIO_BT_GAIN_CUSTOM_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&bt_gain_control_default, DataReset , NULL
        },
        { "/data/nvram/APCFG/APRDCL/AUDIO_FUNC_SWITCH_Param",   VER(AP_CFG_RDCL_FILE_AUDIO_FUNC_SWITCH_PARAM_LID), CFG_FILE_AUDIO_FUNC_SWITCH_PARAM_SIZE,
